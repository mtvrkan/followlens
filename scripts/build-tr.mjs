 ...
 *
 * The output carries no comments, including no "generated, do not edit" banner:
 * docs/ is published byte for byte and anyone can read it with view-source. That
 * warning lives in docs/README.md, and the reasoning behind the page itself in
 * SITE-NOTES.md at the repository root.
 */
...
writeFileSync(
  OUT,
  // No "generated, do not edit" banner in the output: the page is served as-is
  // and every comment in docs/ is readable by anyone who opens view-source. The
  // warning lives in this file's header and in docs/README.md instead.
