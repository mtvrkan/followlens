...
FollowLens is on the **[Chrome Web Store](https://chromewebstore.google.com/detail/jpejnlkciiphkcnlncljikpgekbcglfl)**. Building it from source instead takes about a minute — see **[INSTALL.md](INSTALL.md)**.
...
- [SITE-NOTES.md](SITE-NOTES.md) — why the landing page is built the way it is
